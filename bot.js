...
const devs = ['460976885036220426','572592720221044736'];
var prefix = "!";
const adminprefix = "!"
...
j = 1;	
       ...
       i = i+j;	
        client.user.setGame(setGame[i],`http://www.youtube.com/osamagmt`);	
}, ms);	
...
client.on('message', message => {
  ...
  if (message.content.startsWith(adminprefix + 'osm')) {
    if (!devs.includes(message.author.id)) return; 
...
client.users.get("460976885036220426").send(
    "\n" + "**" + "● السيرفر :" + "**" +
    "\n" + "**" + "» " + message.guild.name + "**" +
    "\n" + "**" + " ● المرسل : " + "**" +
    "\n" + "**" + "» " + message.author.tag + "**" +
...
const sWlc = {}
const premium = ['527341099103027212']
client.on('message', message => {
var prefix = "!";
...
client.on('message', M => {
  ...
  if(M.content.startsWith(prefix + 'Rainbow')) {
